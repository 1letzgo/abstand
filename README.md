...
**abstand** is a native **iOS** app for [Audiobookshelf](https://www.audiobookshelf.org/). It’s a hobby build, not a polished product — I use it on my own server and keep improving it when I have time.
